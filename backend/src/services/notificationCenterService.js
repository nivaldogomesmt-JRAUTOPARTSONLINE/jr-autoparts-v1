...
const DEFAULT_EVENTS = [
  {
    ...
    active: true,
    dedupeHours: 48,
    template: 'Ola, {clientName}! A manutencao do seu {brand} {model} ({plate}) foi iniciada. OS #{soNumber}. Acompanhe pelo portal: {portalUrl}',
  },
  {
    key: 'OS_STATUS_IN_PROGRESS',
    module: 'OS',
    title: 'OS em execucao',
    channel: 'WHATSAPP',
    active: true,
    dedupeHours: 48,
    template: 'Ola, {clientName}! Seu {brand} {model} ({plate}) esta em manutencao neste momento. OS #{soNumber}. Status: {statusLabel}.',
  },
  {
    key: 'OS_STATUS_WAITING_PART',
    module: 'OS',
    title: 'OS aguardando peca',
    channel: 'WHATSAPP',
    active: true,
    dedupeHours: 48,
    template: 'Ola, {clientName}! Seu {brand} {model} ({plate}) esta aguardando peca para continuidade do servico. OS #{soNumber}.',
  },
  {
    ...
    active: true,
    dedupeHours: 48,
    template: 'Ola, {clientName}! O servico do seu {brand} {model} ({plate}) esta em fase final. OS #{soNumber}.',
  },
  {
    key: 'OS_STATUS_DONE',
    module: 'OS',
    ...
    active: true,
    dedupeHours: 48,
    template: 'Ola, {clientName}! O servico do seu {brand} {model} ({plate}) foi concluido. OS #{soNumber}. Em breve faremos a liberacao/entrega.',
  },
  {
    ...
    active: true,
    dedupeHours: 48,
    template: 'Ola, {clientName}! Seu {brand} {model} ({plate}) foi entregue. Obrigado pela preferencia. Portal: {portalUrl}',
  },
  {
  ...
  },
  {
    ...
    active: true,
    dedupeHours: 72,
    template: 'Ola, {clientName}! A manutencao {maintenanceLabel} do veiculo {plate} esta proxima do vencimento.\nNivel: {alertLabel}.\nPrevisao: {nextDate} ou {nextKm}.\nAcompanhe no portal: {portalUrl}',
  },
  {
    ...
    active: true,
    dedupeHours: 168,
    template: 'Ola, {clientName}! A manutencao {maintenanceLabel} do veiculo {plate} esta vencida.\nNivel: {alertLabel}.\nPrevisao: {nextDate} ou {nextKm}.\nAcompanhe no portal: {portalUrl}',
  },
  {
